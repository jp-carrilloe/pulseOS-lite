...
The LLM wiki idea is a big piece of the answer. But for enterprise use, we think the next step is turning company knowledge into something that is not only readable by humans, but structurally usable by agents.
...
- a local CLI and daemon
- a graph UI for ontology and document relationships
...
We are a small team working very hard on this, backed by investors, and we are looking for strong people who want to help build it. If that is you, write me at [juan@tintto.com](mailto:juan@tintto.com).
