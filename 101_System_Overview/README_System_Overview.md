...
2.  **Execution Hub:** `502_Execution_Engine/agents/` contains symlinks to all canonical agents for rapid task-scoped loops.
...
- **Priority Links:** Root-level symlinks (e.g., `102_Strategy.md`) for instant terminal reference.
